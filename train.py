...
# Параметры для данной модели были подобраны локально с помощью GridSearchCV
decision_tree = DecisionTreeClassifier(max_depth=200, max_leaf_nodes=2000, min_impurity_decrease=0,
